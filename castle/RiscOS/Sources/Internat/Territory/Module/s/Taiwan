...
; 
;-----------------------------------------------------------------------------
; RISC OS Taiwanese Territory
;-----------------------------------------------------------------------------

        GBLS    Help
Help    SETS    "Taiwanese Ter'y"
;                |-------------|   maximum length
...
WriteDir SETA   WriteDirection_LeftToRight :OR: \
 ...
 [ :LNOT::DEF:TaiwanIMESWI_Name
TaiwanIMESWI_Base * &55BC0
 ]

IMESWIChunk SETA TaiwanIMESWI_Base
...
MaxAMPMLength   *       6       ; "ä¸Šåˆ"
MaxWELength     *       9       ; "æ˜ŸæœŸæ—¥"
MaxW3Length     *       9       ; "æ˜ŸæœŸæ—¥"
MaxDYLength     *       2       ; "31"
MaxSTLength     *       3       ; "æ—¥"
MaxMOLength     *       5       ; "12æœˆ"
MaxM3Length     *       5       ; "12æœˆ"
...
;-----------------------------------------------------------------------------
        ...
        GBLS    DateFormat
DateFormat SETS "%ce%yrå¹´%m3%zdyæ—¥"
...
IntCurr         SETS    "TWD "          ; international currency symbol
Currency        SETS    "T$"            ; currency symbol
