...
NODST0  SETS    "GOZ"
        ...
        GBLS    DST0
DST0    SETS    "YS" ; YS for 'Yaz Saati' (Alpnet)
...
UppercaseTable
        ...
        DCD     2_00000100000000000000000000000000 ; Ä
...
LowercaseTable
        ...
        DCD     2_00000000000000000000000000000000 ; @
        DCD     2_00000111111111111111111111111110 ; `
        DCD     2_11001000000000000000000001000000 ; Ä
        DCD     2_00000000000000000000000000000000 ; NBSP
...
AlphaTable
        ...
        DCD     2_00000111111111111111111111111110 ; @
        DCD     2_00000111111111111111111111111110 ; `
        DCD     2_11001100000000000000000001000000 ; Ä
        DCD     2_00000000000000000000000000000000 ; NBSP
        DCD     2_11111111011111111111111111111111 ; ¿
        DCD     2_11111111011111111111111111111111 ; ‡
        MEND
...
AccentedTable
        ...
        DCD     2_00000000000000000000000000000000 ; @
        DCD     2_00000000000000000000000000000000 ; `
        DCD     2_00000000000000000000000001000000 ; Ä
        DCD     2_00000000000000000000000000000000 ; NBSP
...
ToLowerTable
   ...
   DCB    "Ä",129,130,131,132,133,"Ü",135,136,137,138,139,"å","ç","é","è"
...
ToUpperTable
   ...
   DCB    "`","A","B","C","D","E","F","G","H","I","J","K","L","M","N","O"
   DCB    "P","Q","R","S","T","U","V","W","X","Y","Z","{","|","}","~",127
   DCB    "Ä",129,130,131,132,133,"Y",135,136,137,138,139,"å","ç","é","è"
...
ToPlainForCollateTable
   ...
   DCB    "G","N","O","O","O","O","O","◊","O","U","U","U","U","I","S","ﬂ"
   DCB    "a","a","a","a","a","a","Ê","c","e","e","e","e","˝","˝","˝","˝"
...
; [SP][NBSP]!"#$%&'()*+,-≠./0123456789:;<=
; >?@Aa¿‡¡·¬‚√„ƒ‰≈Â∆ÊBbCc«ÁDdEe»Ë…
; È ÍÀÎFfûüGg–HhI˝›iÃÏÕÌŒÓœÔJjKkL
; lMmNn—ÒOo“Ú”Û‘Ù’ı÷ˆÿ¯öõPpQqRrSsﬁ
; ˛ﬂTtUuŸ˘⁄˙€˚‹¸VvWwXxYyˇZz[\]^_`{
; |}~[DEL]ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôúù
; °¢£§•¶ß®©™´¨ÆØ∞±π≤≥¥µ∂∑∏∫ªºΩæø◊˜
