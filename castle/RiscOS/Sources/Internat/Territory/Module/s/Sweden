...
ToPlainForCollateTable
   ...
   DCB    "†","°","¢","£","§","•","¶","ß","®","©","™","´","¨","≠","Æ","Ø"
   DCB    "∞","±","≤","≥","¥","µ","∂","∑","∏","π","∫","ª","º","Ω","æ","ø"
   DCB    "A","A","A","A","ƒ","≈","ƒ","C","E","E","E","E","I","I","I","I"
   DCB    "D","N","O","O","O","O","÷","◊","÷","U","U","U","Y","Y","ﬁ","ﬂ"
   DCB    "a","a","a","a","‰","Â","‰","c","e","e","e","e","i","i","i","i"
   DCB    "d","n","o","o","o","o","ˆ","˜","ˆ","u","u","u","y","y","˛","y"
   MEND
...
;  Nn—ÒOo‘Ù”Û“Ú’ıöõPpQqRrSsﬂTtﬁ˛Uu€˚⁄˙Ÿ˘VvWwÅÇXxYy‹¸ÖÜˇ›˝Zz≈Âƒ‰∆Ê÷ˆÿ¯[\]^_
; `{|}~[DEL]
...
; and fl.
;
; In the Swedish territory, ö=OE, ﬁ=TH, ∆ sorts as an accented ƒ, ÿ sorts as
