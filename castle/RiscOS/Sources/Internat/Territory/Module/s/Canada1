...
DST0    SETS    "HAT"   ; Heure AvancÈe de Terre-Neuve
DST1    SETS    "HAA"   ; Heure AvancÈe de l'Atlantique
DST2    SETS    "HAE"   ; Heure AvancÈe de l'Est
DST3    SETS    "HAC"   ; Heure AvancÈe du Centre
DST4    SETS    "HAR"   ; Heure AvancÈe des Rocheuses
DST5    SETS    "HAP"   ; Heure AvancÈe du Pacifique
...
ToLowerTable
   ...
   DCB    128,"Ç","Ç",131,132,"Ü","Ü",135,136,137,138,139,"å","ç","é","è"
   DCB    "ê","ë","í","ì","î","ï","ñ","ó","ò","ô",154,155,"ú","ù","û","ü"
   DCB    "†","°","¢","£","§","•","®","ß","®","©","™","´","¨","≠","Æ","Ø"
   DCB    "∞","±","≤","≥","∏","µ","∂","∑","∏","π","∫","ª","Ω","Ω","ˇ","ø"
...
ToUpperTable
   ...
   DCB    "`","A","B","C","D","E","F","G","H","I","J","K","L","M","N","O"
   DCB    "P","Q","R","S","T","U","V","W","X","Y","Z","{","|","}","~",127
   DCB    128,"Å","W",131,132,"Ö","Y",135,136,137,138,139,"å","ç","é","è"
   DCB    "ê","ë","í","ì","î","ï","ñ","ó","ò","ô",154,155,"ú","ù","û","ü"
   DCB    "†","°","¢","£","§","•","¶","ß","¶","©","™","´","¨","≠","Æ","Ø"
   DCB    "∞","±","≤","≥","¥","µ","∂","∑","¥","π","∫","ª","º","º","æ","ø"
   DCB    "¿","¡","¬","√","ƒ","≈","∆","«","»","…"," ","À","Ã","Õ","Œ","œ"
...
ToControlTable
   ...
   DCB    128, 23, 23,131,132, 25, 25,135,136,137,138,139,"å","ç","é","è"
   DCB    "ê","ë","í","ì","î","ï","ñ","ó","ò","ô",154,155,"ú","ù","û","ü"
   DCB    "†","°","¢","£","§","•", 19,"ß", 19,"©","™","´","¨","≠","Æ","Ø"
   DCB     29,"±","≤","≥", 26,"µ","∂","∑", 26,"π","∫","ª","º","Ω", 25,"ø"
...
ToPlainForCollateTable
   ...
   DCB    "`","a","b","c","d","e","f","g","h","i","j","k","l","m","n","o"
   DCB    "p","q","r","s","t","u","v","w","x","y","z","{","|","}","~",127
   DCB    128,"W","w",131,132,"Y","y",135,136,137,138,139,"å","ç","é","è"
   DCB    "ê","ë","í","ì","î","ï","ñ","ó","ò","ô",154,155,"ú","ù","û","ü"
   DCB    "†","°","¢","£","§","•","S","ß","s","©","™","´","¨","≠","Æ","Ø"
   DCB    "∞","±","≤","≥","Z","µ","∂","∑","z","π","∫","ª","º","Ω","Y","ø"
...
; @Aa¡·¿‡¬‚≈Âƒ‰√„∆ÊBbCc«ÁDd–Ee…È»Ë ÍÀÎFfûüGgHhIiÕÌÃÏŒÓœÔJjKkLlMm
; Nn—ÒOo”Û“Ú‘Ù÷ˆ’ıÿ¯ºΩPpQqRrSs¶®ﬂTtUu⁄˙Ÿ˘€˚‹¸VvWwÅÇXxYy›˝ÖÜæˇZz¥∏ﬁ˛[\]^_`{|}~[DEL]
; ÄÉÑáàâäãåçéèêëíìîïñóòôöõúù
; °¢£§•ß©™´¨ÆØ∞±π≤≥µ∂∑∫ªø
; ◊
; ˜
...
; example: pÍche < pÈchÈ < pÈcher < pÍcher
