...
; 
;-----------------------------------------------------------------------------
; RISC OS Eire Territory (southern ireland)
; NOTE: This is an English variant, NOT Gaelic
;-----------------------------------------------------------------------------

        GBLS    Help
Help    SETS    "Eire Territory"
;                |-------------|   maximum length
...
IntCurr         SETS    "IEP "          ; international currency symbol
Currency        SETS    "IR£"           ; currency symbol
; jrf: currency matching glibc and windows
;      CIA WFB claims £IR
...
; jrf: 26 Jul 2000
;      glibc claims that the sort order is identical to that of denmark,
;      but then it also claims that uk is equivilent to denmark.
;      [ can't find any specific information about the collation order
;        for Eire. Although gaelic does use a few accented vowels, the
;        sorting order appears to be the same as that from UK, so I have
;        retained this ]
