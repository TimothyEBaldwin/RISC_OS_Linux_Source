...
; 
;-----------------------------------------------------------------------------
; RISC OS Norwegian Territory
;-----------------------------------------------------------------------------

        GBLS    Help
Help    SETS    "Norwegian Ter'y"
;                |-------------|   maximum length
...
IntCurr         SETS    "NOK "          ; international currency symbol
...
; and fl.
;
; In the Norweigan territory, AA=≈, ö=OE, ﬁ=TH, ƒ sorts as an accented ∆, ÷ sorts as
