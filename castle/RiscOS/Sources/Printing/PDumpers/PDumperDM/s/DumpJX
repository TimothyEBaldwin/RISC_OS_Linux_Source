...
;;<        LDREQ   r4, [r7, #pd_leftmargin - pd_data]      ; Margin if no skip
        ...
        BLNE    jx_adjust_skip          ; Tramples on mask in r4.
...
getjx_length Entry "R0-R2,R6"
  [ No32bitCode
stack_getjx_r0 * Proc_RegOffset
  |
        SavePSR r2
        Push    r2
stack_getjx_r0 * Proc_RegOffset + 4
  ]
