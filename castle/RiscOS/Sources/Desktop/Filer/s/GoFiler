...
Filer_Start ROUT
 ...
 DREG r1, "Allocated Filer task handle "
        ...
        ADRL    r1, UpCall_Handler       ; changes to file systems
        MOV     r2, wp
        SWI     XOS_Claim
        SWIVS   OS_GenerateError
...
; More boring initialisation
        ...
        ; Install an error handler to protect us from failures
        ;   in background code
        MOV     r0, #ErrorHandler
        ADRL    r1, Error_Handler
        MOV     r2, wp
        ADR     r3, userdata
...
;        MOV     pc, lr                  ; scroll request
        B       event_scroll_request    ; scroll request
