...
DoLoadByGBPB    ROUT ; Returns if unable, goes bang by itself if needed
        ...
        Pull    pc, EQ                                  ; Return and do the load the easy way, or go bang some other way
...
10
        LDRB    r14, [ r5 ], #1
        TEQ     r14, #"."                               ; Want leaf for monitor name
        MOVEQ   r6, r5                                  ; Adjust to new leaf after that dot
        TEQ     r14, #0
        BNE     %BT10
