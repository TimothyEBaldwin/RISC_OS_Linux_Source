...
;
                ...
                GBLL    PhoebeHardware  ; defunct project
...
standalone      SETL    {FALSE}
 ...
 [ :LNOT::DEF: international
                GBLL    international
international   SETL    {TRUE}          ; Default to 3.60+ messages
 ]
 [ :LNOT::DEF: PCIHardware
                GBLL    PCIHardware
PCIHardware     SETL    {FALSE}         ; Default to IO mapped hardware rather than PCI
 ]

debug           SETL    {FALSE}
hostvdu         SETL    {FALSE}
OldHardware     SETL    {FALSE}
...
flags710        SETD    {FALSE}         ; flag control on 710
...
close           SETD    {FALSE}         ; debugging stream closing
                ...
                GBLS    getaroundaasm
 [ OldHardware
getaroundaasm   SETS    "GET Serial6551.s"
 |
getaroundaasm   SETS    ""
 ]
                $getaroundaasm
 [ NewHardware
getaroundaasm   SETS    "GET Serial710.s"
 |
getaroundaasm   SETS    ""
 ]
                $getaroundaasm
