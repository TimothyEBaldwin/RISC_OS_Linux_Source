...
arith_decode (j_decompress_ptr cinfo, unsigned char *st)
{
  ...
  qe = cinfo->jpeg_aritab[sv & 0x7F];	/* => Qe_Value */
#else
...
start_pass (j_decompress_ptr cinfo)
{
  ...
  if (cinfo->progressive_mode) {
    ...
    /* Select MCU decoding routine */
    entropy->pub.decode_mcu = (boolean (*)(j_decompress_ptr, JBLOCKROW *))RELOCCODE(decode_mcu);
  }
...
jinit_arith_decoder (j_decompress_ptr cinfo)
{
  ...
  entropy->pub.start_pass = (void (*)(j_decompress_ptr))RELOCCODE(start_pass);
#ifdef RISCOS /* Cache relocated table */
  cinfo->jpeg_aritab = (const INT32 *)RELOCDATA(jpeg_aritab);
#endif  
