...
#ifndef RISCOS /* Encode to baseline only, unused */
/*
		  ...
		  c_derived_tbl *dctbl, c_derived_tbl *actbl)
{
  ...
  const char * natural_order = state->cinfo->natural_order;
#else
...
#ifdef RISCOS /* Encode to baseline only, unused */
  entropy->pub.finish_pass = (void (*)(j_compress_ptr))RELOCCODE(finish_pass_huff);
  entropy->pub.encode_mcu = (boolean (*)(j_compress_ptr, JBLOCKROW *))RELOCCODE(encode_mcu_huff);
#else
...
jinit_huff_encoder (j_compress_ptr cinfo)
{
  ...
  entropy->pub.start_pass = (void (*)(j_compress_ptr, boolean))RELOCCODE(start_pass_huff);
